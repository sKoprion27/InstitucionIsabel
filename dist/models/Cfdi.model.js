...
var Cfdi = {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              return _context2.abrupt("return", ['ERROR GET ONE CFDI NOT FOUND 🤯', 404]);
            ...
            case 14:
              ...
              console.log('ERROR GET ONE CFDI 🤯', _context2.t0);
              return _context2.abrupt("return", ['ERROR GET ONE CDFI 🤯', 400]);
  ...
  postOne: function () {
    var _postOne = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(cfdi) {
      var INSERTION;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return _index.db.query(INSERTION, [cfdi.clave, cfdi.descripcion]);

            case 4:
              return _context3.abrupt("return", ['POST CFDI', 201]);

            case 7:
              _context3.prev = 7;
              _context3.t0 = _context3["catch"](1);
              console.log('ERROR POST CFDI 🤯', _context3.t0);
              return _context3.abrupt("return", ['ERROR POST CFDI 🤯', 400]);
  ...
  putOne: function () {
    var _putOne = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(cfdi, id) {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              UPDATE = "\n      UPDATE cfdis\n      SET \n      clave = $2, \n      descripcion = $3\n      WHERE id = $1 \n      AND existe = true\n    ";
              values = [id, cfdi.clave, cfdi.descripcion];
              _context4.prev = 2;
              _context4.next = 5;
            ...
            case 9:
              return _context4.abrupt("return", ['UPDATE ONE CFDI', 201]);

            case 12:
              _context4.prev = 12;
              _context4.t0 = _context4["catch"](2);
              console.log('ERROR UPDATE CFDI 🤯', _context4.t0);
              return _context4.abrupt("return", ['ERROR UPDATE CFDI 🤯', 400]);
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 8:
              return _context5.abrupt("return", ['DELETE ONE CFDI', 201]);

            case 11:
              _context5.prev = 11;
              _context5.t0 = _context5["catch"](1);
              console.log('ERROR DELETE CFDI 🤯', _context5.t0);
              return _context5.abrupt("return", ['ERROR DELETE CFDI 🤯', 400]);
