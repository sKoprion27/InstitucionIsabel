...
var Note = {
  ...
  postOne: function () {
    var _postOne = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id_usuario) {
  ...
  deleteOne: function () {
    var _deleteOne = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(id_usuario) {
      var DELETE;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return _context5.abrupt("return", _index.db.query(DELETE, [id_usuario]));
  ...
  deleteALlUserNotes: function () {
    var _deleteALlUserNotes = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(id_usuario) {
      var DELETE;
    ...
    function deleteALlUserNotes(_x6) {
      return _deleteALlUserNotes.apply(this, arguments);
    }

    return deleteALlUserNotes;
  }()
};
exports.Note = Note;