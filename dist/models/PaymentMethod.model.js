...
var PaymentMethod = {
  ...
  postOne: function () {
    var _postOne = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(paymentMethod) {
      var INSERTION;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", _index.db.query(INSERTION, [paymentMethod.nombre, paymentMethod.descripcion]));
  ...
  putOne: function () {
    var _putOne = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(paymentMethod, id) {
      var UPDATE, values;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              UPDATE = "\n      UPDATE metodos_pago\n      SET nombre = $2,\n      descripcion = $3\n      WHERE id = $1\n      AND existe = true\n    ";
              values = [id, paymentMethod.nombre, paymentMethod.descripcion];
